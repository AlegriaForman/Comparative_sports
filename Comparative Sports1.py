...
plt.title('Histogram of points scored by the Heat in 2013 to 2015', fontsize=18)
...
# Scatterplot
plt.title('Scatterplot of points scored by  the Heat in 2013 to 2015', fontsize=18)
...
plt.hist(your_team_df['pts'], 20, alpha=0.5, label='Heat')
...
print("Points Scored by the Heat in Home Games (2013 to 2015)")
print("-------------------------------------------------------")
...
print("Points Scored by the Heat in Away Games (2013 to 2015)")
print("-------------------------------------------------------")
...
print("Confidence Interval for Average Relative Skill of all NBA teams in the years 2013 to 2015")
print("----------------------------------------------")
...
# Assigned Team the Bulls from 1996-1998.
assigned_years_league_df = nba_orig_df[(nba_orig_df['year_id'].between(1996, 1998))]
assigned_team_df = assigned_years_league_df[(assigned_years_league_df['fran_id']=='Bulls')]

print("Confidence Interval for Average Relative Skill of the Bulls in the years 1996 to 1998.")
print("-----------------------------------------------------------------------")

# Mean relative skill of of the Bulls from the years 1996-1998
mean = assigned_years_league_df['elo_n'].mean()

# Standard deviation of the relative skill of of the Bulls from the years 1996-1998
...
print("95% confidence interval (unrounded) for Average Relative Skill (ELO) of the Bulls in the years 1996 to 1998 =", conf_int_95)
print("95% confidence interval (rounded) for Average Relative Skill (ELO) of the Bulls in the years 1996 to 1998 = (",  round(conf_int_95[0], 2),",", round(conf_int_95[1], 2),")")

print("\n")
print("Probability a team has Average Relative Skill LESS than the Average Relative Skill (ELO) of the Bulls in the years 1996-1998")
print("-----------------------------------------------------------------------")
